...
Для эксперимента использовался синтетический датасет, сгенерированный функцией `make_classification` со следующими параметрами: `n_samples=500`, `n_features=2`, `n_redundant=0`, `n_informative=2`, `random_state=42`, `n_clusters_per_class=1`. Задача представляет собой бинарную классификацию в двумерном признаковом пространстве.
